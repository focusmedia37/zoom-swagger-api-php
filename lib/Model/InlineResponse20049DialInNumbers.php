...
/**
 * InlineResponse20049DialInNumbers Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20049DialInNumbers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_49_dial_in_numbers';
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling InlineResponse20049DialInNumbers., must be smaller than or equal to 6.');
        }
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (mb_strlen($number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $number when calling InlineResponse20049DialInNumbers., must be smaller than or equal to 16.');
        }
        if (!is_null($number) && (mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling InlineResponse20049DialInNumbers., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryLabel($country_label)
    {
        if (!is_null($country_label) && (mb_strlen($country_label) > 10)) {
            throw new \InvalidArgumentException('invalid length for $country_label when calling InlineResponse20049DialInNumbers., must be smaller than or equal to 10.');
        }
