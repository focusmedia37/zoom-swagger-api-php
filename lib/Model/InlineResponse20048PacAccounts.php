...
/**
 * InlineResponse20048PacAccounts Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20048PacAccounts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_48_pac_accounts';
    ...
    protected static $swaggerTypes = [
        'dedicated_dial_in_number' => '\Swagger\Client\Model\InlineResponse20048DedicatedDialInNumber[]',
        'global_dial_in_numbers' => '\Swagger\Client\Model\InlineResponse20048DedicatedDialInNumber[]',
        'conference_id' => 'int',
     ...
     *
     * @return \Swagger\Client\Model\InlineResponse20048DedicatedDialInNumber[]
     */
     ...
     *
     * @param \Swagger\Client\Model\InlineResponse20048DedicatedDialInNumber[] $dedicated_dial_in_number List of dedicated dial-in numbers.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\InlineResponse20048DedicatedDialInNumber[] $global_dial_in_numbers List of global dial-in numbers.
     *
     * @return $this
     */
    ...
    public function setParticipantPassword($participant_password)
    {
        if (!is_null($participant_password) && (mb_strlen($participant_password) > 6)) {
            throw new \InvalidArgumentException('invalid length for $participant_password when calling InlineResponse20048PacAccounts., must be smaller than or equal to 6.');
        }
        if (!is_null($participant_password) && (mb_strlen($participant_password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $participant_password when calling InlineResponse20048PacAccounts., must be bigger than or equal to 1.');
        }
    ...
    public function setListenOnlyPassword($listen_only_password)
    {
        if (!is_null($listen_only_password) && (mb_strlen($listen_only_password) > 6)) {
            throw new \InvalidArgumentException('invalid length for $listen_only_password when calling InlineResponse20048PacAccounts., must be smaller than or equal to 6.');
        }
