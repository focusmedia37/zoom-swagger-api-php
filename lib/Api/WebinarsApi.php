...
class WebinarsApi
{
     ...
     */
    public function webinar($webinar_id, $occurrence_id = null)
    {
        list($response) = $this->webinarWithHttpInfo($webinar_id, $occurrence_id);
        return $response;
    }
     ...
     */
    public function webinarWithHttpInfo($webinar_id, $occurrence_id = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20053';
        $request = $this->webinarRequest($webinar_id, $occurrence_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webinarAsync($webinar_id, $occurrence_id = null)
    {
        return $this->webinarAsyncWithHttpInfo($webinar_id, $occurrence_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webinarAsyncWithHttpInfo($webinar_id, $occurrence_id = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20053';
        $request = $this->webinarRequest($webinar_id, $occurrence_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function webinarRequest($webinar_id, $occurrence_id = null)
    {
        // verify the required parameter 'webinar_id' is set
        if ($webinar_id === null || (is_array($webinar_id) && count($webinar_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse20120
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\InlineResponse20120, HTTP status code, HTTP response headers (array of strings)
     */
    public function webinarRegistrantCreateWithHttpInfo($webinar_id, $body, $occurrence_ids = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20120';
     ...
     *
     * @param  int $webinar_id The webinar ID. (required)
     * @param  \Swagger\Client\Model\Body36 $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
