...
class ReportsApi
{
     ...
     */
    protected function getBillingInvoicesReportsRequest($billing_id = null)
    {
        ...
        // query params
        if ($billing_id !== null) {
            $queryParams['billing_id'] = ObjectSerializer::toQueryValue($billing_id);
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBillingReportRequest()
    {
