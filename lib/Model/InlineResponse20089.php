...
class InlineResponse20089 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'total_records' => 'int',
        'call_queues' => '\Swagger\Client\Model\InlineResponse20089CallQueues[]'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 100)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20089., must be smaller than or equal to 100.');
        }
     ...
     * Gets call_queues
     *
     * @return \Swagger\Client\Model\InlineResponse20089CallQueues[]
     */
     ...
     * Sets call_queues
     *
     * @param \Swagger\Client\Model\InlineResponse20089CallQueues[] $call_queues call_queues
     *
     * @return $this
     */
