...
class UsersuserIdmeetingsRecurrence implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int $repeat_interval At which interval should the meeting repeat? For a daily meeting there's a maximum of 90 days. For a weekly meeting there is a maximum of 12 weeks. For a monthly meeting there is a maximum of 3 months.
     *
     * @return $this
     */
     ...
     * Sets weekly_days
     *
     * @param string $weekly_days Days of the week the meeting should repeat.  Note: Multiple values should be separated by a comma. <br>`1`  - Sunday. <br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` -  Thursday.<br>`6` - Friday.<br>`7` - Saturday.
     *
     * @return $this
     */
     ...
     * Sets monthly_day
     *
     * @param int $monthly_day Day in the month the meeting is to be scheduled. The value range is from 1 to 31.
     *
     * @return $this
     */
     ...
     * Sets monthly_week
     *
     * @param int $monthly_week The week a meeting will recur each month.<br>`-1` - Last week.<br>`1` - First week.<br>`2` - Second week.<br>`3` - Third week.<br>`4` - Fourth week.
     *
     * @return $this
     */
     ...
     *
     * @param int $monthly_week_day The weekday a meeting should recur each month.<br>`1` - Sunday.<br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` - Thursday.<br>`6` - Friday.<br>`7` - Saturday.
     *
     * @return $this
     */
     ...
     * Sets end_times
     *
     * @param int $end_times Select how many times the meeting will recur before it is canceled. (Cannot be used with \"end_date_time\".)
     *
     * @return $this
     */
     ...
     * Sets end_date_time
     *
     * @param \DateTime $end_date_time Select a date the meeting will recur before it is canceled. Should be in UTC time, such as 2017-11-25T12:00:00Z. (Cannot be used with \"end_times\".)
     *
     * @return $this
     */
