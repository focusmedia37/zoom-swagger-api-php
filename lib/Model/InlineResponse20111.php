...
class InlineResponse20111 implements ModelInterface, ArrayAccess
{
     ...
     * Sets join_url
     *
     * @param string $join_url URL to join the meeting. If the meeting was [created](https://marketplace.zoom.us/docs/api-reference/zoom-api/meetings/meetingcreate) with manual approval type (`approval_type`: 1), the join URL will not be returned.
     *
     * @return $this
     */
