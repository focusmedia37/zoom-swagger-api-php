...
class InlineResponse20094 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'page_size' => 'int',
        'total_records' => 'int',
        'common_area_phones' => '\Swagger\Client\Model\InlineResponse20094CommonAreaPhones[]'
    ];
    ...
    public function setTotalRecords($total_records)
    {
        ...
        if (!is_null($total_records) && ($total_records > 100)) {
            throw new \InvalidArgumentException('invalid value for $total_records when calling InlineResponse20094., must be smaller than or equal to 100.');
        }
     ...
     *
     * @return \Swagger\Client\Model\InlineResponse20094CommonAreaPhones[]
     */
     ...
     *
     * @param \Swagger\Client\Model\InlineResponse20094CommonAreaPhones[] $common_area_phones common_area_phones
     *
     * @return $this
     */
