...
class InlineResponse20046 implements ModelInterface, ArrayAccess
{
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling InlineResponse20046., must be smaller than or equal to 64.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling InlineResponse20046., must be smaller than or equal to 64.');
        }
