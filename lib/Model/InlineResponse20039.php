...
class InlineResponse20039 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'page_count' => 'int',
        'page_size' => 'int',
        'participants' => '\Swagger\Client\Model\InlineResponse20039Participants[]',
        'total_records' => 'int'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20039., must be smaller than or equal to 300.');
        }
     ...
     * Gets participants
     *
     * @return \Swagger\Client\Model\InlineResponse20039Participants[]
     */
     ...
     * Sets participants
     *
     * @param \Swagger\Client\Model\InlineResponse20039Participants[] $participants Array of webinar participant objects.
     *
     * @return $this
     */
