...
class InlineResponse20093 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'page_size' => 'int',
        'total_records' => 'int',
        'users' => '\Swagger\Client\Model\InlineResponse20093Users[]'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 100)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20093., must be smaller than or equal to 100.');
        }
     ...
     * Gets users
     *
     * @return \Swagger\Client\Model\InlineResponse20093Users[]
     */
     ...
     * Sets users
     *
     * @param \Swagger\Client\Model\InlineResponse20093Users[] $users users
     *
     * @return $this
     */
