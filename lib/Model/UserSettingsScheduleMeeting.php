...
class UserSettingsScheduleMeeting implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool $require_password_for_scheduling_new_meetings Require a password when scheduling new meetings
     *
     * @return $this
     */
     ...
     *
     * @param string $require_password_for_pmi_meetings Require a password for Personal Meeting ID (PMI)
     *
     * @return $this
     */
