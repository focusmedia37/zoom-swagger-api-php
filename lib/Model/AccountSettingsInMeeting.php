...
class AccountSettingsInMeeting implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool $attention_tracking Allows the host to see an indicator in the participant panel if a meeting or webinar attendee does not have Zoom in focus while screen sharing.
     *
     * @return $this
     */
