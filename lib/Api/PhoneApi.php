...
class PhoneApi
{
     ...
     */
    public function accountCallLogs($page_size = '30', $page_number = '1', $from = null, $to = null, $type = null)
    {
        list($response) = $this->accountCallLogsWithHttpInfo($page_size, $page_number, $from, $to, $type);
        return $response;
    }
     ...
     */
    public function accountCallLogsWithHttpInfo($page_size = '30', $page_number = '1', $from = null, $to = null, $type = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20065';
        $request = $this->accountCallLogsRequest($page_size, $page_number, $from, $to, $type);
     ...
     */
    public function accountCallLogsAsync($page_size = '30', $page_number = '1', $from = null, $to = null, $type = null)
    {
        return $this->accountCallLogsAsyncWithHttpInfo($page_size, $page_number, $from, $to, $type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountCallLogsAsyncWithHttpInfo($page_size = '30', $page_number = '1', $from = null, $to = null, $type = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20065';
        $request = $this->accountCallLogsRequest($page_size, $page_number, $from, $to, $type);
     ...
     */
    protected function accountCallLogsRequest($page_size = '30', $page_number = '1', $from = null, $to = null, $type = null)
    {
     ...
     * @param  \Swagger\Client\Model\Body47 $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     *
     * @param  string $user_id user_id (required)
     * @param  \Swagger\Client\Model\Body46 $body Provide either an id or a number in the request body. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function phoneUserCallLogs($user_id, $from, $to, $page_size = '30', $page_number = '1', $type = null)
    {
        list($response) = $this->phoneUserCallLogsWithHttpInfo($user_id, $from, $to, $page_size, $page_number, $type);
        return $response;
    }
     ...
     */
    public function phoneUserCallLogsWithHttpInfo($user_id, $from, $to, $page_size = '30', $page_number = '1', $type = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20062';
        $request = $this->phoneUserCallLogsRequest($user_id, $from, $to, $page_size, $page_number, $type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function phoneUserCallLogsAsync($user_id, $from, $to, $page_size = '30', $page_number = '1', $type = null)
    {
        return $this->phoneUserCallLogsAsyncWithHttpInfo($user_id, $from, $to, $page_size, $page_number, $type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function phoneUserCallLogsAsyncWithHttpInfo($user_id, $from, $to, $page_size = '30', $page_number = '1', $type = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20062';
        $request = $this->phoneUserCallLogsRequest($user_id, $from, $to, $page_size, $page_number, $type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function phoneUserCallLogsRequest($user_id, $from, $to, $page_size = '30', $page_number = '1', $type = null)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function phoneUserRecordings($user_id, $page_size = '30', $page_number = '1')
    {
        list($response) = $this->phoneUserRecordingsWithHttpInfo($user_id, $page_size, $page_number);
        return $response;
    }
     ...
     */
    public function phoneUserRecordingsWithHttpInfo($user_id, $page_size = '30', $page_number = '1')
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20063';
        $request = $this->phoneUserRecordingsRequest($user_id, $page_size, $page_number);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function phoneUserRecordingsAsync($user_id, $page_size = '30', $page_number = '1')
    {
        return $this->phoneUserRecordingsAsyncWithHttpInfo($user_id, $page_size, $page_number)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function phoneUserRecordingsAsyncWithHttpInfo($user_id, $page_size = '30', $page_number = '1')
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20063';
        $request = $this->phoneUserRecordingsRequest($user_id, $page_size, $page_number);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function phoneUserRecordingsRequest($user_id, $page_size = '30', $page_number = '1')
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function phoneUserVoiceMails($user_id, $page_size = '30', $page_number = '1', $status = 'all')
    {
        list($response) = $this->phoneUserVoiceMailsWithHttpInfo($user_id, $page_size, $page_number, $status);
        return $response;
    }
     ...
     */
    public function phoneUserVoiceMailsWithHttpInfo($user_id, $page_size = '30', $page_number = '1', $status = 'all')
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20064';
        $request = $this->phoneUserVoiceMailsRequest($user_id, $page_size, $page_number, $status);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function phoneUserVoiceMailsAsync($user_id, $page_size = '30', $page_number = '1', $status = 'all')
    {
        return $this->phoneUserVoiceMailsAsyncWithHttpInfo($user_id, $page_size, $page_number, $status)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function phoneUserVoiceMailsAsyncWithHttpInfo($user_id, $page_size = '30', $page_number = '1', $status = 'all')
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20064';
        $request = $this->phoneUserVoiceMailsRequest($user_id, $page_size, $page_number, $status);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function phoneUserVoiceMailsRequest($user_id, $page_size = '30', $page_number = '1', $status = 'all')
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
