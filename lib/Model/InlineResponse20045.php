...
class InlineResponse20045 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'page_size' => 'int',
        'total_records' => 'int',
        'users' => '\Swagger\Client\Model\InlineResponse20045Users[]'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20045., must be smaller than or equal to 300.');
        }
     ...
     * Gets users
     *
     * @return \Swagger\Client\Model\InlineResponse20045Users[]
     */
     ...
     * Sets users
     *
     * @param \Swagger\Client\Model\InlineResponse20045Users[] $users List of user objects.
     *
     * @return $this
     */
