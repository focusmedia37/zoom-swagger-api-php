...
class InlineResponse20097 implements ModelInterface, ArrayAccess
{
    ...
    public function setPhoneNumber($phone_number)
    {
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling InlineResponse20097., must be smaller than or equal to 50.');
        }
    ...
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineResponse20097., must be smaller than or equal to 255.');
        }
