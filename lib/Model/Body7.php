...
class Body7 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
        'type' => 'int',
        'members' => '\Swagger\Client\Model\ChatusersmechannelsMembers[]'
    ];
     ...
     * Gets members
     *
     * @return \Swagger\Client\Model\ChatusersmechannelsMembers[]
     */
     ...
     * Sets members
     *
     * @param \Swagger\Client\Model\ChatusersmechannelsMembers[] $members Member(s) to include in the channel. A max of 5 members can be added to the channel at once with this API.
     *
     * @return $this
     */
