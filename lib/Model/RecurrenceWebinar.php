...
class RecurrenceWebinar implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int $repeat_interval At which interval should the webinar repeat? For a daily webinar, there's a maximum of 90 days. For a weekly webinar, there is a maximum of 12 weeks. For a monthly webinar, there is a maximum of 3 months.
     *
     * @return $this
     */
     ...
     * Sets weekly_days
     *
     * @param int $weekly_days Days of the week the webinar should repeat.  Note: Multiple values should be separated by a comma. <br>`1`  - Sunday. <br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` -  Thursday.<br>`6` - Friday.<br>`7` - Saturday.
     *
     * @return $this
     */
     ...
     * Sets monthly_day
     *
     * @param int $monthly_day Day in the month the webinar is to be scheduled. The value range is from 1 to 31.
     *
     * @return $this
     */
     ...
     * Sets monthly_week
     *
     * @param int $monthly_week The week for a webinar to recur each month.<br>`-1` - Last week.<br>`1` - First week.<br>`2` - Second week.<br>`3` - Third week.<br>`4` - Fourth week.
     *
     * @return $this
     */
     ...
     *
     * @param int $monthly_week_day The weekday a webinar should recur each month.<br>`1` - Sunday.<br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` - Thursday.<br>`6` - Friday.<br>`7` - Saturday.
     *
     * @return $this
     */
