...
class MeetingsApi
{
     ...
     *
     * @param  int $meeting_id The meeting ID. (required)
     * @param  string $occurrence_id Meeting occurrence id (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse20022
     */
    public function meeting($meeting_id, $occurrence_id = null)
    {
        list($response) = $this->meetingWithHttpInfo($meeting_id, $occurrence_id);
        return $response;
    }
     ...
     */
    public function meetingWithHttpInfo($meeting_id, $occurrence_id = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20022';
        $request = $this->meetingRequest($meeting_id, $occurrence_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function meetingAsync($meeting_id, $occurrence_id = null)
    {
        return $this->meetingAsyncWithHttpInfo($meeting_id, $occurrence_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function meetingAsyncWithHttpInfo($meeting_id, $occurrence_id = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20022';
        $request = $this->meetingRequest($meeting_id, $occurrence_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function meetingRequest($meeting_id, $occurrence_id = null)
    {
        // verify the required parameter 'meeting_id' is set
        if ($meeting_id === null || (is_array($meeting_id) && count($meeting_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  \Swagger\Client\Model\Body22 $body Meeting object. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20110';
     ...
     *
     * @param  int $meeting_id The meeting ID. (required)
     * @param  \Swagger\Client\Model\Body42 $body Meeting (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $user_id The user ID or email address of the user. For user-level apps, pass &#x60;me&#x60; as the value for userId. (required)
     * @param  string $type The meeting types: &lt;br&gt;&#x60;scheduled&#x60; - All the scheduled meetings.&lt;br&gt;&#x60;live&#x60; - All the live meetings.&lt;br&gt;&#x60;upcoming&#x60; - All the upcoming meetings. (optional, default to live)
     * @param  int $page_size The number of records returned within a single API call. (optional, default to 30)
     * @param  int $page_number The current page number of returned records. (optional, default to 1)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
