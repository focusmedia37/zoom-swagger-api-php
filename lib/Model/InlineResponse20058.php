...
class InlineResponse20058 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'client_feedback_details' => '\Swagger\Client\Model\InlineResponse20058ClientFeedbackDetails[]',
        'from' => '\DateTime',
     ...
     *
     * @return \Swagger\Client\Model\InlineResponse20058ClientFeedbackDetails[]
     */
     ...
     *
     * @param \Swagger\Client\Model\InlineResponse20058ClientFeedbackDetails[] $client_feedback_details client_feedback_details
     *
     * @return $this
     */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20058., must be smaller than or equal to 300.');
        }
