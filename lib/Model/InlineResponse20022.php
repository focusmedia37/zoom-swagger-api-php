...
class InlineResponse20022 implements ModelInterface, ArrayAccess
{
     ...
     * Sets id
     *
     * @param int $id Meeting ID: also known as the meeting number.
     *
     * @return $this
     */
     ...
     * Sets timezone
     *
     * @param string $timezone Timezone to format the meeting start time.
     *
     * @return $this
     */
